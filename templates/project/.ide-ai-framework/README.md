...
- `skills/` - full Codex-parity workflow skills and a `index.json` registry.
...
- `codex-parity/` - fuller source assets from the Codex-style setup: hook scripts, custom agent specs, and compact prompts.
