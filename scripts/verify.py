...
EXPECTED = [
    ...
    "templates/project/.ide-ai-framework/skills/tdd/SKILL.md",
    "templates/project/.ide-ai-framework/skills/tdd/tests.md",
    "templates/project/.ide-ai-framework/skills/github-triage/SKILL.md",
    "templates/project/.ide-ai-framework/skills/context-engineering/SKILL.md",
    ...
    "templates/project/.ide-ai-framework/codex-parity/agents/reviewer.toml",
    "templates/project/.ide-ai-framework/codex-parity/agents/test_worker.toml",
    "templates/project/.ide-ai-framework/codex-parity/hooks/smart_router.py",
    "templates/project/.ide-ai-framework/codex-parity/hooks/pre_tool_use_policy.py",
    "templates/project/.ide-ai-framework/codex-parity/hooks/telemetry_common.py",
    "templates/project/.ide-ai-framework/codex-parity/compact-prompts/context-engineering.md",
